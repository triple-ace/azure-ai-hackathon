...
# merge all data
# =============================================================================
df_all=pd.merge(df_agg_flights_wth, df_covid, how= "left", left_on=['Departure_state','Date'], right_on=['state','date'])

#fill NaN values with 0
df_all['positive']=df_all['positive'].fillna(0).astype('int')
